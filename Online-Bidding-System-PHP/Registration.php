...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO customer_account(i_num,f_name,l_name,email,phone,password,address,city,country) 
    VALUES('$i_num','$f_name','$l_name','$email','$phone','$password','$address','$city','$country')";
        ...
        <div class="row main">
            <div class="main-login main-center">
                <h3>User Registration Form</h5>
                    <form action="signUpProcess.php" method="get" enctype="multipart/form-data" name="Registerform"
