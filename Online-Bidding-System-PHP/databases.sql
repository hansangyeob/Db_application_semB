...
insert into customer_account (i_num, first_name, last_name, email, phone, password, address, city, country, profile_pic, balance, registered_branch) values (20, 'test_first_name', 'test_last_name', 'user1@gmail.com', '00000000', '1234', '45952 Ramsey Crossing', 'Denton', 'United Kingdom', 'http://dummyimage.com/249x100.png/cc0000/ffffff', 0,1);
...
insert into admin (a_email, a_password) values ('admin1@gmail.com', '123456');
