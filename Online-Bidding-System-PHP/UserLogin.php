        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="Registration.php"><span class="glyphicon glyphicon-user"></span> <b>Sign Up</b></a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <p class="text-center login-title" style="font-size:small;">You can use your email or phone number to
                    login</p>
